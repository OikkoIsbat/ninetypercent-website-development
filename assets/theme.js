...
/* currency switcher */
  ...
  DOMready(function(){
    ...
    theme.sections.register('np-welcome-popUp', theme.NewsletterPopup);
    ...
    document.dispatchEvent(new CustomEvent('page:loaded'));
     ...
     // slick slider for new arrival section on homepage
 ...
 (function pollFor() {
          if (document.querySelector('.recently-viewed-container .recently-viewed-slide .grid__item')) {
              try {
                 $(".recently-viewed-container .recently-viewed-slide").slick({
        dots: true,
        infinite: true,
        speed: 300,
        centerMode: false,
 ...
 (function pollFor() {
          if (document.querySelector('.product-recommendations .grid--uniform .grid__item')) {
              try {
     ...
     $(".page-content--product .pdp-mobile-slider").slick({
        dots: false,
        infinite: true,
        speed: 300,
        centerMode: false,
...
        prevArrow: '<div class="arrow-wrapper left"><i class="arrow-left"></div>',
   ...
   document.querySelectorAll('.site-nav__item').forEach((item)=> {
    ...
    $('.flickity-slider .product-main-slide').each(function(){
  $(this).mouseover(function(){
    $('.product-main-slide').not(this).removeClass('is-selected');
